# bettbox+ 预览版本发布
**注意：预览版本通常包含最新的功能修复增强或不确定性，如遇问题请提交issue[[反馈]](https://github.com/Tiam9173/bettboxplus/issues/new)联系社区交流。**
