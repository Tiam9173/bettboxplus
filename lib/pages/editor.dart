...
class _EditorPageState extends ConsumerState<EditorPage> {
  ...
  _EditorFindController? _findController;
  UndoRedoController? _undoController;
  late TextEditingController _titleController;
  late TextEditingController _fallbackTextController;
  bool _hasRustBackend = true;
  ...
  void initState() {
    ...
    try {
      ...
      controller.tabSize = 2;
      controller.text = widget.content;
      _controller = controller;
      _findController = _EditorFindController(controller);
      _undoController = UndoRedoController();
      _hasRustBackend = true;
    } catch (e) {
      commonPrint.log('CodeForgeController init failed, using fallback editor: $e');
      _hasRustBackend = false;
      _fallbackTextController = TextEditingController(text: widget.content);
    }
  ...
  Future<bool> _handleNativePaste() async {
    ...
    if (_hasRustBackend && _controller != null) {
  ...
  void _handleSearch() {
    if (_hasRustBackend && _findController != null) {
  ...
  void _handleSave(BuildContext context) {
    ...
    final currentText = _hasRustBackend && _controller != null
        ? _controller!.text
        : _fallbackTextController.text;
    ...
    widget.onSave!(context, _titleController.text, currentText);
  }
  ...
  Future<void> _handleImport() async {
    ...
    if (option == ImportOption.file) {
      ...
      if (_hasRustBackend && _controller != null) {
        ...
        _fallbackTextController.text = res;
      }
      return;
    }
    ...
    if (_hasRustBackend && _controller != null) {
      ...
      _fallbackTextController.text = res.data;
    }
  ...
  Widget build(BuildContext context) {
    ...
    final menuItems = <PopupMenuItemData>[
      ...
      if (_hasRustBackend && _undoController != null) ...[
        PopupMenuItemData(
          icon: Icons.undo,
              ...
              actions: genActions([
                if (widget.onSave != null && !readOnly)
                  _wrapTitleController(
                    () {
                      final isNewScript = widget.title.isEmpty;
                      final currentContent = _hasRustBackend && _controller != null
                          ? _controller!.text
                          : _fallbackTextController.text;
                      final canSave =
                          !_isLoading &&
                ...
                ListenableBuilder(
                  listenable: _hasRustBackend && _undoController != null
                      ? _undoController!
                      : _fallbackTextController,
