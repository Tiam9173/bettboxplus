  ...
  List<_SearchItem> _buildSearchItems(List<NavigationItem> moreItems) {
    ...
    items.addAll([
      ...
      _SearchItem(
        ...
        subtitle: appLocalizations.chainProxyDesc,
        category: settingsCategory,
        leading: const Icon(Icons.alt_route),
        onTap: (context, _) => _pushPage(
          context,
          appLocalizations.chainProxy,
          const ChainProxyView(),
        ),
      ),
      if (system.isDesktop)
        _SearchItem(
...
class _ChainProxyItem extends StatelessWidget {
  const _ChainProxyItem();
  ...
  Widget build(BuildContext context) {
    return ListItem.next(
      leading: const Icon(Icons.alt_route),
      title: Text(appLocalizations.chainProxy),
      subtitle: Text(appLocalizations.chainProxyDesc),
      delegate: NextDelegate(
        title: appLocalizations.chainProxy,
